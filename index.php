	...
	<div id="home" class="hero-area">
		...
		<div class="home-wrapper">
			<div class="container">
				<div class="row">
					<div class="col-md-8">
						<h1 class="white-text">Streptococcus Agalactiae</h1>
						<p class="lead white-text">A research made in Brazil 2018 where you can extract informations about non-codings RNA </p>
						<a class="main-button icon-button" href="search.php">Search!</a>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="row">
				...
				<div class="col-md-6">
					<div class="section-header">
						<h2>Welcome to Streptococcus Agalactiae</h2>
