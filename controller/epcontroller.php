...
class EpController {
  ...
  public function getDetails($params) {
    ...
    return $this->Dao->getDetails('abbreviation,loc_identification, feature.start, feature.end, strand, feature.sequence, feature_name,feature.bit_score,feature_rf,feature.e_value', $where, $values);
  }
